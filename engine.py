...
'''
second_gate = load_model(os.path.join(os.getcwd(),'ft_model_1.h5'))
print("Second gate loaded")
'''
location_model = load_model('static/models/ft_model_2.h5')
print("Location model loaded")
'''
severity_model = load_model(os.path.join(os.getcwd(),'ft_model_3.h5'))
...
def prepare_img_224(img_path):
	...
	img = load_img('save.png', target_size=(224, 224))
	x = img_to_array(img)
